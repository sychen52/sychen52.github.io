...
|                                |                                      | x.size                                           |
|--------------------------------+--------------------------------------+--------------------------------------------------|
| *Stack*                        | s = list()                           | std::stack<int> s;                               |
|                                | s.append(xxx)                        | s.push(xxx);                                     |
|                                | yyy = s.pop()                        | s.pop();                                         |
|                                | s[-1]                                | s.top();                                         |
|--------------------------------+--------------------------------------+--------------------------------------------------|
...
|                                | q.queue[0]                           |                                                  |
|--------------------------------+--------------------------------------+--------------------------------------------------|
| *Priority queue*               | q = list() # smallest on top         | std::priority\underqueue<T> q; // largest on top |
|                                | heapq.heappush(q, xxx)               | q.push(xxx);                                     |
|                                | yyy = heapq.heappop(q)               | q.pop();                                         |
|                                | q[0]                                 | q.top();                                         |
|--------------------------------+--------------------------------------+--------------------------------------------------|
...
|                                | q.queue[0]                           |                                                  |
|--------------------------------+--------------------------------------+--------------------------------------------------|
| *Hash map*                     | d=dict()                             | std::unordered_map<k_type,v_type> d;             |
...
|--------------------------------+--------------------------------------+--------------------------------------------------|
| *Hash set*                     | s=set()                              | std::unordered_set<int> s;                       |
|                                | item in s                            | s.find(item) != d.end()                          |
|                                | s.add(item)                          | s.insert(xxx)                                    |
|                                | s.remove(item) # item has to be in   |                                                  |
|                                | s.discard(item) # item can be not in | s.erase(xxx) // item can be not in s             |
