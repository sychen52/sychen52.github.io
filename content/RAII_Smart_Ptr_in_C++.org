...
- Unless you want to do something to the unique_ptr itself.
** const unique_ptr or const shared_ptr
- This means the smart_ptr object is const, can you cannot modify (e.g. reset) the smart_ptr. This is not the smart version of const Raw*. 
** const unique_ptr& or const shared_ptr&
