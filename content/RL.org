...
- cs285 lecture 9 explains why we want the policy before and after update to be close.
...
** Tricks:
*** Experience Replay
- For previous on-policy algorithms, such as VPG, TRPO, and PPO. The loss function and the gradient term has an expectation term sample over the current policy. This makes the old experience unusable.
