...
** Aperture mode + auto ISO: 
   - Default shutter speed: Compute the slowest shutter speed based on focal length to be hand-shake-proof.
   - Default state: the default shutter speed (e.g. 1/100s), the lowest ISO (e.g. 160).
   - If environment is darker, keep default shutter speed, use higher ISO.
